...
x=0:Dx:1;
% y1,y2,y3 gibi baþlangýç deðerleri 0 olarak alýnmýþtýr.
m=length(x);
y0=0;
%% döngü
for i=2:m
...
%% bulunan son daki Y deðeri ilk deðer ile arasýndaki 
% fark olmasý gerekecektir. fakat ilk  deðer 0 olduðundan ayný deðer
% x=1 deki Y deðeridir.
B=B';
%% TDMA solutýon 
A=Y;
A;
